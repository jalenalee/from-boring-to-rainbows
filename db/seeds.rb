...
# Comment Creations 
@comment_rand = Comment.create([{date: DateTime.now(), content: 'Lorem ipsum dolor amet ugh everyday carry cray XOXO tumeric mixtape iceland literally. Helvetica photo booth tilde kogi flexitarian, unicorn sriracha pork belly. Cold-pressed before they sold out franzen poke, heirloom VHS chartreuse skateboard wayfarers tattooed vegan tbh tilde meh taiyaki. Aesthetic mustache pop-up, live-edge cold-pressed XOXO butcher vinyl. \n ', user_id: @jalena.id, post_id: @comp1405post.id}, {date: DateTime.now(), content: 'This is also awesome! Keep it up!', user_id: @johnny_appleseed.id, post_id: @another_post.id}, {date: DateTime.now(), content: 'Mannsplaining blah blah blah... Let me know how I can be helpful.', user_id: @chad.id, post_id: @another_post.id}])
